...
- [x] Add the first council
- [x] Add the first topic
...
```text
data/        raw, processed, ai-cache, analysed, schemas
src/         ingest · transform · analyse · publish
pages/       built site output (generated by CI, not committed)
