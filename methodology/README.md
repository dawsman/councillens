...
**Money is quoted as the council published it.** District councils budget by service group rather than by team, and Norwich is no exception: its 2026-27 General Fund budget puts licensing inside planning and regulatory services. So the money on the licensing page is that group's money, £5.4m of spending against £2.4m of income, and the note says as much rather than implying a licensing-only figure that nobody has published. We went looking for one in the budget book and again in the payments-over-£500 data. Neither has it. Both absences are written up as gaps.
